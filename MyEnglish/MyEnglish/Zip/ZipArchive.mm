...
//	zipInfo.dosDate = (unsigned long) current;
	...
	//NSDictionary* attr = [[NSFileManager defaultManager] fileAttributesAtPath:file traverseLink:YES]; // warning
...
-(BOOL) UnzipFileTo:(NSString*) path overWrite:(BOOL) overwrite
{
	...
	do{
		...
		//NSString * strPath = [NSString  stringWithCString:filename]; //	warning: 'stringWithCString:' is deprecated (declared at ... )
