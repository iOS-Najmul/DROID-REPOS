...
//static NSString *const iRateMessageTitleKey = NSLocalizedString(@"Rate This App!", @"");
//static NSString *const iRateAppMessageKey = NSLocalizedString(@"Would you rate this app?", @"");
//static NSString *const iRateGameMessageKey = @"iRateGameMessage";
//static NSString *const iRateCancelButtonKey = NSLocalizedString(@"Cancel", @"");
//static NSString *const iRateRemindButtonKey = NSLocalizedString(@"Remind me", @"");
//static NSString *const iRateRateButtonKey = NSLocalizedString(@"Rate Now", @"");
//static NSString *const iRateMessageTitleKey = @"Info";
//static NSString *const iRateAppMessageKey = @"Would you rate this app?";
//static NSString *const iRateGameMessageKey = @"iRateGameMessage";
//static NSString *const iRateCancelButtonKey = @"Cancel";
//static NSString *const iRateRemindButtonKey = @"Remind me";
//static NSString *const iRateRateButtonKey = @"Rate Now";
...
{
    @private
//    NSString *iRateMessageTitleKey;
//    NSString *iRateAppMessageKey;
//    NSString *iRateGameMessageKey;
//    NSString *iRateCancelButtonKey;
//    NSString *iRateRemindButtonKey;
//    NSString *iRateRateButtonKey;
...
//@property (nonatomic, strong) NSString *iRateMessageTitleKey;
//@property (nonatomic, strong) NSString *iRateAppMessageKey;
//@property (nonatomic, strong) NSString *iRateGameMessageKey;
//@property (nonatomic, strong) NSString *iRateCancelButtonKey;
//@property (nonatomic, strong) NSString *iRateRemindButtonKey;
//@property (nonatomic, strong) NSString *iRateRateButtonKey;
