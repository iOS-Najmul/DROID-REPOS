...
//@synthesize  iRateMessageTitleKey, iRateAppMessageKey, iRateGameMessageKey, iRateCancelButtonKey, iRateRemindButtonKey, iRateRateButtonKey;
...
- (NSString *)localizedStringForKey:(NSString *)key withDefault:(NSString *)defaultString
{
    ...
    DLog(@"key : %@", key);
    DLog(@"defaultString : %@", defaultString);
    defaultString = [bundle localizedStringForKey:key value:defaultString table:nil];
    DLog(@"defaultString : %@", defaultString);
    DLog(@"defaultString : %@", [[NSBundle mainBundle] localizedStringForKey:key value:defaultString table:nil]);
...
- (iRate *)init
{
    if ((self = [super init]))
    {
        ...
        self.daysUntilPrompt = 10.0f;       //이 숫자의 날짜만큼 지나야 Rate를 띄워준다.
...
{
    return _messageTitle ?: [self localizedStringForKey:NSLocalizedString(@"Info", @"") withDefault:NSLocalizedString(@"Info", @"")];

//    return [_messageTitle ?: [self localizedStringForKey:NSLocalizedString(@"Info", @"") withDefault:@"Rate %@"] stringByReplacingOccurrencesOfString:@"%@" withString:self.applicationName];
}
...
- (NSString *)message
{
    ...
    if (!message)
    {
//        message = (self.appStoreGenreID == iRateAppStoreGameGenreID)? [self localizedStringForKey:NSLocalizedString(@"Info", @"") withDefault:NSLocalizedString(@"If you enjoy playing this app, would you mind taking a moment to rate it? It won’t take more than a minute. Thanks for your support!", @"")]: [self localizedStringForKey:NSLocalizedString(@"Would you rate this app?", @"") withDefault:NSLocalizedString(@"If you enjoy playing this app, would you mind taking a moment to rate it? It won’t take more than a minute. Thanks for your support!", @"")];
        message = (self.appStoreGenreID == iRateAppStoreGameGenreID)? [self localizedStringForKey:NSLocalizedString(@"If you enjoy playing this app, would you mind taking a moment to rate it? It won’t take more than a minute. Thanks for your support!", @"") withDefault:NSLocalizedString(@"If you enjoy playing this app, would you mind taking a moment to rate it? It won’t take more than a minute. Thanks for your support!", @"")]: [self localizedStringForKey:NSLocalizedString(@"If you enjoy playing this app, would you mind taking a moment to rate it? It won’t take more than a minute. Thanks for your support!", @"") withDefault:NSLocalizedString(@"If you enjoy playing this app, would you mind taking a moment to rate it? It won’t take more than a minute. Thanks for your support!", @"")];
...
{
    return _cancelButtonLabel ?: [self localizedStringForKey:NSLocalizedString(@"No, Thanks", @"") withDefault:NSLocalizedString(@"No, Thanks", @"")];
}

- (NSString *)rateButtonLabel
{
    return _rateButtonLabel ?: [self localizedStringForKey:NSLocalizedString(@"Rate It Now", @"") withDefault: NSLocalizedString(@"Rate It Now", @"")];
}

- (NSString *)remindButtonLabel
{
    return [_remindButtonLabel length]? _remindButtonLabel: [self localizedStringForKey:NSLocalizedString(@"Remind Me Later", @"") withDefault:NSLocalizedString(@"Remind Me Later", @"")];
}
