...
+ (void)showErrorWithStatus:(NSString *)string {
    //NSLog(@"showErrorWithStatus STARTED.");
    [SVProgressHUD showImage:[UIImage imageNamed:@"SVProgressHUD.bundle/error.png"] status:string];
    //NSLog(@"showErrorWithStatus ENDED.");
}

+ (void)showImage:(UIImage *)image status:(NSString *)string {
   // NSLog(@"showImage STARTED %@ %@.",string,image);
    NSTimeInterval displayInterval = [[SVProgressHUD sharedView] displayDurationForString:string];
    //NSLog(@"showImage displayInterval %f ",displayInterval);
    SVProgressHUD *hud = [SVProgressHUD sharedView];
    //NSLog(@"showImage hud %@ ",hud);
    [hud showImage:image status:string duration:displayInterval];
    //NSLog(@"showImage STARTED.");
}
